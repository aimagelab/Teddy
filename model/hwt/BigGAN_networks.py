...
from model.hwt.transformer import Transformer
from model.hwt import BigGAN_layers as layers
from model.hwt.networks import init_weights
...
class Discriminator(nn.Module):
    ...
    def __init__(self, D_ch=64, D_wide=True, resolution=None,
                 D_kernel_size=3, D_attn='64', n_classes=None,
...
class WDiscriminator(nn.Module):
    ...
    def __init__(self, D_ch=64, D_wide=True, resolution=None,
                 D_kernel_size=3, D_attn='64', n_classes=None,
                 num_D_SVs=1, num_D_SV_itrs=1, D_activation=nn.ReLU(inplace=False),
                 SN_eps=1e-8, output_dim=None, D_mixed_precision=False, D_fp16=False,
                 D_init='N02', skip_init=False, D_param='SN', gpu_ids=[0], bn_linear='SN', input_nc=1, one_hot=False, **kwargs):
