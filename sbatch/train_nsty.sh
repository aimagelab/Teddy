...
srun /homes/$(whoami)/.conda/envs/teddy/bin/python train.py --root_path /work/FoMo_AIISDH/vpippi/Teddy/files/datasets/ --wandb --tag eccv_no_style_loss --resume --run_id nsty --wsl 0 --wsg 0