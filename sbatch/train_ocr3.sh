...
srun /homes/$(whoami)/.conda/envs/teddy/bin/python train.py --root_path /work/FoMo_AIISDH/vpippi/Teddy/files/datasets/ --wandb --tag eccv_3_ocr_freezed --resume --run_id ocr3 --ocr_scheduler alt3